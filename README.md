...
- Write unit tests!!
- Use linting.
- Use the product search service at https://github.com/CognizantFSE/fse-assessment-4-product-search-service.git as your backing service.  Clone the repo, then refer to the README included with the search service for details on how to start/use it.
